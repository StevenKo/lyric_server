...
set :application, "lyric_server"
set :rails_env, "production"

set :branch, "master"
set :repository,  "https://github.com/StevenKo/lyric_server.git"
set :scm, "git"
set :user, "apps" # 一個伺服器上的帳戶用來放你的應用程式，不需要有sudo權限，但是需要有權限可以讀取Git repository拿到原始碼
set :port, "222"

set :deploy_to, "/home/apps/lyric_server"
set :deploy_via, :remote_cache
set :use_sudo, false

role :web, "106.187.102.167"
role :app, "106.187.102.167"
role :db,  "106.187.102.167", :primary => true
